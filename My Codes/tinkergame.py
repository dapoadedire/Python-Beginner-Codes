...
def result(human_choice,comp_choice):
    ...
    text_area.grid(column=15,row=7)
...
button4=tk.Button(text="         Play Again          ",bg="orange", height=1,width=8,font=('arial',15,'bold'))
button4.grid(column=15,row=4)  

button5=tk.Button(text="         Yes          ",bg="yellow", height=1,width=8,font=('arial',15,'bold'))
button5.grid(column=15,row=5)

button6=tk.Button(text="         No          ",bg="yellow", height=1 ,width=8,font=('arial',15,'bold'))
button6.grid(column=15,row=6)  
